...
@class SBMainSwitcherViewController; @class SpringBoard; @class SBSwitcherAppSuggestionContentView; @class SBMediaController; 
...
static void _logos_method$tweak$SBSwitcherAppSuggestionContentView$_insertCardForDisplayIdentifier$atIndex$(_LOGOS_SELF_TYPE_NORMAL SBSwitcherAppSuggestionContentView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1, unsigned long long arg2) {
	_logos_orig$tweak$SBSwitcherAppSuggestionContentView$_insertCardForDisplayIdentifier$atIndex$(self, _cmd, arg1, arg2);
